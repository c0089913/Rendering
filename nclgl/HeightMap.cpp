...
Vector3 vertexScale = Vector3(4.0f, 3.0f, 4.0f);
Vector2 textureScale = Vector2(1 / 4.0f, 1 / 4.0f);
...
Vector3 HeightMap::GetHeightAtPoint(int x, int z)
{
	int offset = x + z * iWidth;
	return Vector3(x*vertexScale.x, vertices[offset].y, z*vertexScale.z);
}
